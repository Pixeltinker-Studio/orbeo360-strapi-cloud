...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    map_transform: Schema.Attribute.Component<'shared.map', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSceneScene extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::scene.scene'> &
      Schema.Attribute.Private;
    map_position: Schema.Attribute.Component<'shared.vector2', false>;
